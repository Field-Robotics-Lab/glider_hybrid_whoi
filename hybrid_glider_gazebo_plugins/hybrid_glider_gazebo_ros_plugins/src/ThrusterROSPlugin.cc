...
#include <hybrid_glider_gazebo_ros_plugins/ThrusterROSPlugin.hh>
                             ...
                             sdf::ElementPtr _sdf)
{
  ...
  this->subThrustReference = this->rosNode->subscribe<
    hybrid_glider_gazebo_ros_plugins_msgs::FloatStamped
...
void ThrusterROSPlugin::RosPublishStates()
{
      ...
      this->rosPublishPeriod)
  {
    ...
    hybrid_glider_gazebo_ros_plugins_msgs::FloatStamped thrustMsg;
