...
#include <hybrid_glider_gazebo_plugins/FinPlugin.hh>

#include <boost/scoped_ptr.hpp>
#include <gazebo/common/Plugin.hh>
#include <ros/ros.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/FloatStamped.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/GetListParam.h>
#include <geometry_msgs/WrenchStamped.h>
#include <map>

namespace hybrid_glider_simulator_ros
{
  class FinROSPlugin : public hybridglider::FinPlugin
  {
    /// \brief Constrcutor.
    public: FinROSPlugin();
    ...
    public: bool GetLiftDragParams(
      hybrid_glider_gazebo_ros_plugins_msgs::GetListParam::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::GetListParam::Response& _res);  
