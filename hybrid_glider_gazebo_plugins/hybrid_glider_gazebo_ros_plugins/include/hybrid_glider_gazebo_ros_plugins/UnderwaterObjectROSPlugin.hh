...
#include <hybrid_glider_gazebo_ros_plugins_msgs/SetUseGlobalCurrentVel.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/UnderwaterObjectModel.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/GetModelProperties.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/SetFloat.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/GetFloat.h>
...
{
  class UnderwaterObjectROSPlugin : public hybridglider::UnderwaterObjectPlugin
  {
    /// \brief Constructor
    ...
    public: bool SetUseGlobalCurrentVel(
      hybrid_glider_gazebo_ros_plugins_msgs::SetUseGlobalCurrentVel::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::SetUseGlobalCurrentVel::Response& _res);
    ...
    public: bool GetModelProperties(
      hybrid_glider_gazebo_ros_plugins_msgs::GetModelProperties::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::GetModelProperties::Response& _res);

    /// \brief Set the scaling factor for the added-mass matrix
    public: bool SetScalingAddedMass(
      hybrid_glider_gazebo_ros_plugins_msgs::SetFloat::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::SetFloat::Response& _res);

    /// \brief Return current scaling factor for the added-mass matrix
    public: bool GetScalingAddedMass(
      hybrid_glider_gazebo_ros_plugins_msgs::GetFloat::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::GetFloat::Response& _res);
    ...
    protected: virtual void InitDebug(gazebo::physics::LinkPtr _link,
      hybridglider::HydrodynamicModelPtr _hydro);
