...
#include <hybrid_glider_gazebo_plugins/ThrusterPlugin.hh>

#include <boost/scoped_ptr.hpp>
#include <gazebo/common/Plugin.hh>
#include <ros/ros.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/FloatStamped.h>
#include <geometry_msgs/WrenchStamped.h>
#include <std_msgs/Bool.h>
#include <std_msgs/Float64.h>

#include <hybrid_glider_gazebo_ros_plugins_msgs/SetThrusterState.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/GetThrusterState.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/SetThrusterEfficiency.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/GetThrusterEfficiency.h>
#include <hybrid_glider_gazebo_ros_plugins_msgs/GetThrusterConversionFcn.h>

namespace hybrid_glider_simulator_ros
{
  class ThrusterROSPlugin : public hybridglider::ThrusterPlugin
  {
    /// \brief Constrcutor.
    ...
    public: void SetThrustReference(
        const hybrid_glider_gazebo_ros_plugins_msgs::FloatStamped::ConstPtr &_msg);
    ...
    public: bool SetThrustForceEfficiency(
      hybrid_glider_gazebo_ros_plugins_msgs::SetThrusterEfficiency::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::SetThrusterEfficiency::Response& _res);

    /// \brief Get the thrust efficiency factor
    public: bool GetThrustForceEfficiency(
      hybrid_glider_gazebo_ros_plugins_msgs::GetThrusterEfficiency::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::GetThrusterEfficiency::Response& _res);
    ...
    public: bool SetThrusterState(
      hybrid_glider_gazebo_ros_plugins_msgs::SetThrusterState::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::SetThrusterState::Response& _res);

    /// \brief Get thruster state
    public: bool GetThrusterState(
      hybrid_glider_gazebo_ros_plugins_msgs::GetThrusterState::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::GetThrusterState::Response& _res);

    /// \brief Get thruster conversion function parameters
    public: bool GetThrusterConversionFcn(
      hybrid_glider_gazebo_ros_plugins_msgs::GetThrusterConversionFcn::Request& _req,
      hybrid_glider_gazebo_ros_plugins_msgs::GetThrusterConversionFcn::Response& _res);
