...
from hybrid_glider_gazebo_ros_plugins_msgs.msg import UnderwaterObjectModel
from hybrid_glider_gazebo_ros_plugins_msgs.srv import *

PKG = 'hybrid_glider_gazebo_ros_plugins'
NAME = 'test_default_hybrid_glider'

import roslib; roslib.load_manifest(PKG)


class TestDefaultHybridGlider(unittest.TestCase):
...
if __name__ == '__main__':
    import rosunit
    rosunit.unitrun(PKG, NAME, TestDefaultHybridGlider)
