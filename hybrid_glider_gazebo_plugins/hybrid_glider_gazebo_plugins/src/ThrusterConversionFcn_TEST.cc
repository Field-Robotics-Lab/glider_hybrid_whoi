...
#include <hybrid_glider_gazebo_plugins/ThrusterConversionFcn.hh>

std::shared_ptr<hybridglider::ConversionFunction> ConversionFromString(
    const std::string& description)
{
  ...
  std::shared_ptr<hybridglider::ConversionFunction> func;
  func.reset(hybridglider::ConversionFunctionFactory::GetInstance().
