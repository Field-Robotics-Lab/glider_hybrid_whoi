...
#ifndef __HYBRID_GLIDER_GAZEBO_PLUGINS_BUOYANT_OBJECT_HH__
#define __HYBRID_GLIDER_GAZEBO_PLUGINS_BUOYANT_OBJECT_HH__
...
{
  /// \brief Constructor
  public: BuoyantObject(sdf::ElementPtr _sdf, physics::LinkPtr _link);
  ...
  public: void ApplyBuoyancyForce(double m_h, double m_s, double m_w, const ignition::math::Vector3d &_cog);
