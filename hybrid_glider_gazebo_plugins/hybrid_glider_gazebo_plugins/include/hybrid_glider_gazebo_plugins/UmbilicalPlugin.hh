...
#ifndef __HYBRID_GLIDER_GAZEBO_PLUGINS_UMBILICAL_PLUGIN_HH__
#define __HYBRID_GLIDER_GAZEBO_PLUGINS_UMBILICAL_PLUGIN_HH__
...
#include <hybrid_glider_gazebo_plugins/UmbilicalModel.hh>
