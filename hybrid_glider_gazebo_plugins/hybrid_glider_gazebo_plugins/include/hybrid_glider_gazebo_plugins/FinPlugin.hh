...
#ifndef __HYBRID_GLIDER_GAZEBO_PLUGINS_FIN_PLUGIN_HH__
#define __HYBRID_GLIDER_GAZEBO_PLUGINS_FIN_PLUGIN_HH__
...
#include <hybrid_glider_gazebo_plugins/LiftDragModel.hh>
