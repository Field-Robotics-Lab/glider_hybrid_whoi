...
#ifndef __KINEMATICS_SC_ROS_INTERFACE_PLUGIN_HH__
#define __KINEMATICS_SC_ROS_INTERFACE_PLUGIN_HH__
...
#include <kinematics_ros_plugins_msgs/TransformToSphericalCoord.h>
#include <kinematics_ros_plugins_msgs/TransformFromSphericalCoord.h>
...
class SphericalCoordinatesROSInterfacePlugin : public WorldPlugin
{
  ...
  public: bool GetOriginSphericalCoord(
      kinematics_ros_plugins_msgs::GetOriginSphericalCoord::Request& _req,
      kinematics_ros_plugins_msgs::GetOriginSphericalCoord::Response& _res);

  /// \brief Service call that returns the origin in WGS84 standard
  public: bool SetOriginSphericalCoord(
      kinematics_ros_plugins_msgs::SetOriginSphericalCoord::Request& _req,
      kinematics_ros_plugins_msgs::SetOriginSphericalCoord::Response& _res);

  /// \brief Service call to transform from Cartesian to spherical coordinates
  public: bool TransformToSphericalCoord(
      kinematics_ros_plugins_msgs::TransformToSphericalCoord::Request& _req,
      kinematics_ros_plugins_msgs::TransformToSphericalCoord::Response& _res);

  /// \brief Service call to transform from spherical to Cartesian coordinates
  public: bool TransformFromSphericalCoord(
      kinematics_ros_plugins_msgs::TransformFromSphericalCoord::Request& _req,
      kinematics_ros_plugins_msgs::TransformFromSphericalCoord::Response& _res);
...
#endif // __KINEMATICS_SC_ROS_INTERFACE_PLUGIN_HH__
